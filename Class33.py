...
# Create a loop to run until the game is quit by the user
done = False
...
# Activity 2 - Add image to the screen
...
pygame.display.set_caption("Adding penguin image and background image")
